...
export function CanvasViewportView({
  ...
  return (
    ...
    >
      ...
      <OverlayLayer view={editorState.view} />
      ...
      <CanvasDialogs
        ...
        canImportPendingPsdToLibrary={
          pendingFile?.name.toLowerCase().endsWith(".psd") ?? false
        }
      ...
      {exportAreaMoveMode && (
        ...
        >
          ...
          <Button type="button" size="sm" onClick={viewport.saveExportAreaMove}>
            Save
          </Button>
        </div>
      )}
