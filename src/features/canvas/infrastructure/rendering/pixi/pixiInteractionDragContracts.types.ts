...
interface AnimationGestureState {
  isAnimMode: boolean;
  gestureId: string | null | undefined;
}
...
export type DragState =
  ...
  | (LinkedTransformState & {
      ...
      lastScaleX: number;
      lastScaleY: number;
      linkedScaleSnapshot?: LinkedScaleSnapshot;
    })
  | (AnimationGestureState & {
      type: "boneMove";
      boneId: BoneId;
      boneIds: BoneId[];
      startBones: BoneSnapshot;
      setupEffectiveValues: EffectiveValues;
      startClientX: number;
      startClientY: number;
      startWorldX: number;
      startWorldY: number;
      useDraftPose: boolean;
      lastDx: number;
      lastDy: number;
      setupPoseCleared?: boolean;
    })
  | (AnimationGestureState & {
      type: "boneRotate";
      boneId: BoneId;
  ...
  | (AnimationGestureState & {
      ...
      boneId: BoneId;
      boneIds: BoneId[];
      startLengths: Record<string, number>;
      setupEffectiveValues: EffectiveValues;
      pivotX: number;
      pivotY: number;
      startLength: number;
  ...
  | {
      ...
      boneId: BoneId;
      inverse: Matrix3;
      initialInfluences: VertexInfluence[][] | undefined;
    }
  | {
      type: "exportAreaMove";
      startWorldX: number;
