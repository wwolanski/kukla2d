...
describe("SchemaAnalysisDetailsDialog", () => {
  it("explains analyzers and renders expected and actual raw values", () => {
    const match: SchemaComparisonResult = {
      ...
      unmatchedComponentIds: [],
      assignments: [{ slotKey: "left-foot", componentIds: [6], scoreBp: 9800 }],
      analyzers: [
        {
          analyzerId: "relations.size-ratio",
          analyzerVersion: 1,
          status: "scored",
          scoreBp: 9700,
          passed: true,
    ...
    act(() =>
      root.render(
        <SchemaAnalysisDetailsDialog match={match} onClose={() => {}} />,
      ),
    );
