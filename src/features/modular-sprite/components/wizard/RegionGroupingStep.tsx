  ...
  return (
    <aside className="space-y-4 overflow-auto rounded-lg border p-4">
      <p className="text-xs text-muted-foreground">
        Group detected regions into the images that should be imported as parts.
        Part names come from detection or schema matching; correct them directly
        in the tree when needed. Anatomical roles are reviewed in the next step.
        Shift-click selects several regions.
      </p>
      <UiButton
        className="w-full"
        size="sm"
